...
var strat = {
    ...
    init: function()
    {
        ...
        // stop loss
        store.buyPrice = 0; // start at 0
        this.state = 'WaitingBuy';
    ...
    check: function(candle)
    {
        ...
        this.last_candle = candle.close;
        this.gain = (this.last_candle-store.buyPrice)/store.buyPrice*100

        if (this.gain < -20){
            if(this.state == 'WaitingSold'){
                log.info('Stop Loss @ '+ this.gain);
                log.remote('Stop Loss @ '+ this.gain+ ' %');
                this.short();
            }
        }
